          ...
          <div class="col-12 col-md-9 col-lg-7 col-xl-6">
            <div class="card" style="border-radius: 15px;">
              <div class="card-body p-5">
                <h2 class="text-uppercase text-center mb-5">Agregar Cliente:</h2>
                ...
                <form method="POST">
                  ...
                  <div class="d-flex justify-content-center">
                    <button type="submit" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">Ingresar</button>
                  </div>
...
<!-- FORMULARIO -->
  ...
  if (isset($_POST['txt_nom'])) {
    ...
    $abml->AgregarClientes($ci, $nom, $ape, $dir, $tel, $email);
  }
  ?>
